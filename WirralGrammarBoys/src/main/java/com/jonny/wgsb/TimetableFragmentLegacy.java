...
public class TimetableFragmentLegacy extends Fragment {
    ...
    public class EditDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(TimetableFragmentLegacy.this.getActivity());

            LinearLayout editView = new LinearLayout(TimetableFragmentLegacy.this.getActivity());
            editView.setPadding(dp(16), dp(8), dp(16), dp(8));
            editView.setOrientation(LinearLayout.VERTICAL);

            LinearLayout idRoom = new LinearLayout(TimetableFragmentLegacy.this.getActivity());
            LinearLayout idTeacher = new LinearLayout(TimetableFragmentLegacy.this.getActivity());
            final EditText id = new EditText(TimetableFragmentLegacy.this.getActivity());
            id.setHint("ID");
            id.setMaxEms(2);
            id.setMaxLines(1);
            id.setText(formerId);
            idRoom.addView(id);
            final EditText teacher = new EditText(TimetableFragmentLegacy.this.getActivity());
            ...
            final EditText room = new EditText(TimetableFragmentLegacy.this.getActivity());
            room.setHint("Room");
            room.setEms(6);
            room.setMaxLines(1);
            ...
            final AutoCompleteTextView name = new AutoCompleteTextView(TimetableFragmentLegacy.this.getActivity());
            ...
            RelativeLayout timeBreak = new RelativeLayout(TimetableFragmentLegacy.this.getActivity());
            LinearLayout timesLayout = new LinearLayout(TimetableFragmentLegacy.this.getActivity());
            timesLayout.setOrientation(LinearLayout.HORIZONTAL);
            timesLayout.setGravity(Gravity.CENTER_HORIZONTAL);
            RelativeLayout startRelative = new RelativeLayout(TimetableFragmentLegacy.this.getActivity());
            startRelative.setPadding(dp(8), 0, dp(8), 0);
            Spinner startSpinner = new Spinner(TimetableFragmentLegacy.this.getActivity());
            startAdapter = new ArrayAdapter<String>(TimetableFragmentLegacy.this.getActivity(), R.layout.timetable_spinner_text, R.id.spinner_text);
            ...
            View startSet = new View(TimetableFragmentLegacy.this.getActivity());
            ...
            TextView dash = new TextView(TimetableFragmentLegacy.this.getActivity());
            dash.setText(" - ");
            timesLayout.addView(dash);
            RelativeLayout endRelative = new RelativeLayout(TimetableFragmentLegacy.this.getActivity());
            startRelative.setPadding(dp(8), 0, dp(8), 0);
            Spinner endSpinner = new Spinner(TimetableFragmentLegacy.this.getActivity());
            endAdapter = new ArrayAdapter<String>(TimetableFragmentLegacy.this.getActivity(), R.layout.timetable_spinner_text, R.id.spinner_text);
            ...
            View endSet = new View(TimetableFragmentLegacy.this.getActivity());
            ...
            final CheckBox breakCheck = new CheckBox(TimetableFragmentLegacy.this.getActivity());
            ...
            builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    ContentResolver cr = TimetableFragmentLegacy.this.getActivity().getContentResolver();
    ...
    public class RemoveDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(TimetableFragmentLegacy.this.getActivity());
            TextView confirmRemove = new TextView(TimetableFragmentLegacy.this.getActivity());
