...
public class TimetableSettingsActivityLegacy extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            TimetableSettingsFragmentLegacy TimetableSettingsFragmentLegacy = new TimetableSettingsFragmentLegacy();
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.fragment_container_timetable, TimetableSettingsFragmentLegacy, "TIMETABLE_SETTINGS_FRAGMENT").commit();
        }
    }
            ...
            case CONFIRM_DIALOG_ID:
                ...
                builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Intent backToHome = new Intent(TimetableSettingsActivityLegacy.this, TimetableTabController.class);
            ...
            case RESTORE_DIALOG_ID:
                ...
                builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        progressDialog = new ProgressDialog(TimetableSettingsActivityLegacy.this);
                        ...
                        cr.delete(TimetableProvider.PERIODS_URI, null, null);
                        cr.delete(TimetableProvider.WEEK_URI, null, null);
                        TimetableBackupRestore.restore(TimetableSettingsActivityLegacy.this);
    ...
    public static class TimetableSettingsFragmentLegacy extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            if (item.getItemId() == android.R.id.home) {
                Intent intent = new Intent(getActivity(), TimetableTabControllerLegacy.class);
