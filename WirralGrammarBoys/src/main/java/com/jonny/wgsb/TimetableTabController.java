...
public class TimetableTabController extends ActionBarActivity implements ViewPager.OnPageChangeListener {
            ...
            case CONFIRM_DIALOG_ID:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        startActivity(new Intent(TimetableTabController.this, TimetableTabController.class));
                        dialog.dismiss();
                    }
                });
            ...
            case RESTORE_DIALOG_ID:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        progressDialog = new ProgressDialog(TimetableTabController.this);
                        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                        progressDialog.setMessage("Restoring...");
                        progressDialog.setCancelable(false);
                        progressDialog.show();
                        Intent backToHome = new Intent(TimetableTabController.this, TimetableTabController.class);
                        backToHome.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        ContentResolver cr = getContentResolver();
                        cr.delete(TimetableProvider.PERIODS_URI, null, null);
                        cr.delete(TimetableProvider.WEEK_URI, null, null);
                        TimetableBackupRestore.restore(TimetableTabController.this);
	...
	private void refresh() {
		if (tablet) {
			...
			Intent refresh = new Intent(TimetableTabController.this, TimetableTabController.class);
